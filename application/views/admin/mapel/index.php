			...
			<tbody>
				...
				?>
					<tr>
						...
						<td>
							<a href="<?= base_url() ?>admin/mapel/edit/<?= $mapel['id_mapel'] ?>" class="btn btn-warning btn-sm">
								<i class="fa fa-edit"></i> Edit
							</a>
							<a href="<?= base_url() ?>admin/mapel/hapus/<?= $mapel['id_mapel'] ?>" class="btn btn-danger btn-sm">
