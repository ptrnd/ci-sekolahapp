        ...
        <div class="col-lg-6">
            ...
            <div class="form-group">
                ...
                <select class="custom-select" id="mapel" name="mapel">
                    ...
                    <?php if ($mapel['id'] == set_value('mapel')) : ?>
            ...
            <div class="form-group">
                ...
                <select class="custom-select" id="kelas" name="kelas">
                    ...
                    <?php if ($kelas['id'] == set_value('kelas')) : ?>
